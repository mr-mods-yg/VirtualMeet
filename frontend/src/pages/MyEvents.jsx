...
function MyEvents() {
    ...
    useEffect(() => {
        axiosInstance.get("/event/getMyEvents"+ (showPastEvents ? "?showPastEvents=true" : "") ).then((res) => {
            setEvents(res.data);
        });
    }, [showPastEvents])
                ...
                <div className='flex-col text-center'>
                    ...
                    <div className='bg-medium-purple-300 rounded-xl p-3 mt-3'>
                        ...
                        <div className='flex bg-white mx-5 my-2 p-1 rounded-xl gap-2 justify-center items-center'>
                            <input type="checkbox" className="toggle" onChange={showPastEventsHandler}/>
                            Show past events
                        </div>
                ...
                {events.map((event) => {
                    ...
                    return <EventComponent
                        ...
                        submitHandler={async (e) => {
                            ...
                            axiosInstance.get("/event/getMyEvents").then((res) => {
                                setEvents(res.data);
                            });
                        }}
                    />
